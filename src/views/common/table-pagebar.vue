...
//						// 返回总记录数
//						//						_this.totalSize = res.data[0].total;
//						_this.totalSize = res.data.length;
//						//返回总页数
//						_this.totalPage = Math.ceil(_this.totalSize / _this.limit);
//						//刷新页码按钮
//						_this.refreshPageCon();
//						_this.$emit('refresh', _this.dataList);
//					})
...
<style>
	...
	.page-size-box>select::-ms-expand {
		display: none;
	}
</style>